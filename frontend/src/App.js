...
function App() {
  ...
  const renderMyNotes = () => {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-8 text-blue-600">Mina anteckningar</h2>
        
        {myNotes.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Du har inte laddat upp några anteckningar ännu.</p>
            <button
              onClick={() => setCurrentView('upload')}
            ...
            {myNotes.map((note) => (
              <div key={note.id} className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">
                  ...
                  <p><strong>Pris:</strong> {note.price === 0 ? 'Gratis' : `${note.price} kr`}</p>
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => handleNoteClick(note.id)}
                    className="flex-1 bg-blue-100 text-blue-600 py-2 px-4 rounded-lg hover:bg-blue-200 text-sm"
                  >
                    Visa detaljer
                  </button>
                  ...
                  {!note.is_deleted && (
                    <>
                      <button
                        onClick={() => handleEditNote(note)}
                        className="flex-1 bg-green-100 text-green-600 py-2 px-4 rounded-lg hover:bg-green-200 text-sm"
                      >
                        Redigera
                      </button>
                      ...
                      <button
                        onClick={() => handleDeleteNote(note.id)}
                        className="flex-1 bg-red-100 text-red-600 py-2 px-4 rounded-lg hover:bg-red-200 text-sm"
                      >
                        Ta bort
                      </button>
                    </>
  ...
  const renderMyPurchases = () => {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-8 text-blue-600">Köpta anteckningar</h2>
        
        {myPurchases.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Du har inte köpt några anteckningar ännu.</p>
            <button
              onClick={() => setCurrentView('search')}
              className="mt-4 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700"
            >
            ...
            {myPurchases.map((note) => (
              <div key={note.id} className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="text-sm text-gray-600 mb-3">
                  ...
                  <p><strong>Köpt:</strong> {new Date(note.purchase_date).toLocaleDateString('sv-SE')}</p>
                </div>
